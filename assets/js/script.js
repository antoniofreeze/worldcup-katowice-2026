...
const I18N = {
  en: {
    ...
    "donate.title":"Make a donation","donate.sub":"Choose any amount you wish — 50% of every donation goes directly to Franek, the rest supports the Foundation's work.","donate.cta":"Donate now","donate.methods":"Apple Pay · Card · PayPal · Google Pay","donate.trust":"🔒 Secure payment via Stripe","franek.link":"Franek's official fundraising page →",
  ...
  it: {
    ...
    "donate.title":"Fai una donazione","donate.sub":"Scegli l'importo che preferisci — il 50% di ogni donazione va direttamente a Franek, il resto sostiene il lavoro della Fondazione.","donate.cta":"Dona ora","donate.methods":"Apple Pay · Carta · PayPal · Google Pay","donate.trust":"🔒 Pagamento sicuro con Stripe","franek.link":"Pagina ufficiale della raccolta per Franek →",
  ...
  pl: {
    ...
    "donate.title":"Przekaż darowiznę","donate.sub":"Wybierz dowolną kwotę — 50% każdej darowizny trafia bezpośrednio do Franka, reszta wspiera działania Fundacji.","donate.cta":"Wesprzyj teraz","donate.methods":"Apple Pay · Karta · PayPal · Google Pay","donate.trust":"🔒 Bezpieczna płatność przez Stripe","franek.link":"Oficjalna zbiórka dla Franka →",
